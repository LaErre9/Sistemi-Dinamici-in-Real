...
% Dati dell'edificio in legno
M1=2.5e5;   % massa totale del primo solaio  
M2=1.25e5;  % massa totale del secondo solaio 
Ka1=8e4;  % coefficiente di attrito del primo piano 
Ka2=5e4;  % coefficiente di attrito del secondo piano
Ke1=2.5e6;  % rigidezza del primo piano
Ke2=1.25e6; % rigidezza del secondo piano
H1=3.5;  % quota del primo solaio
H2=7;   % quota del secondo solaio

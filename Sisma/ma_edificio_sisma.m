...
% Dati dell'edificio in muratura armata
M1=1.315e5;   % massa totale del primo solaio  
M2=.63e5;  % massa totale del secondo solaio 
Ka1=8e4;  % coefficiente di attrito del primo piano 
Ka2=6e4;  % coefficiente di attrito del secondo piano
Ke1=6e6;  % rigidezza del primo piano
Ke2=4e6; % rigidezza del secondo piano
H1=6.5;  % quota del primo solaio
H2=13;   % quota del secondo solaio
